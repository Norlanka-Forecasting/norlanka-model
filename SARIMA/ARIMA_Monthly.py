...
data = pd.read_csv('Datasets/C_datasets/C_dataset_monthly_original.csv',parse_dates=True,index_col='Date')
print(data)
y = data

# The 'MS' string groups the data in buckets by start of the month
y = y['Price'].resample('MS').mean()
...
pred = results.get_prediction(start=pd.to_datetime('2021-10-01'), end=pd.to_datetime('2022-04-01'), dynamic=False)
