...
data =  pd.read_csv('Datasets/B_datasets/B_dataset_monthly_original.csv', parse_dates=['Date'], index_col=['Date'])
...
train_data = data[0:29]
test_data = data[29:36]

all_index = pd.date_range(start=pd.to_datetime('2019-05-01'), end=pd.to_datetime('2022-04-30'), freq='M')
all_price_data =  pd.Series(data, all_index)

train_index= pd.date_range(start=pd.to_datetime('2019-05-01'), end=pd.to_datetime('2021-09-30'), freq='M')
train_price_data = pd.Series(train_data, train_index)

test_index= pd.date_range(start=pd.to_datetime('2021-10-01'), end=pd.to_datetime('2022-04-30'), freq='M')
